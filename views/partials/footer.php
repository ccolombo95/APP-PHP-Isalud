<footer class="page-footer">
  <div class="footer-content">
    ...
    <div class="content-section contact-wrapper">
      <h3 class="section-title">Suscribite</h3>
      <form action="index.html" method="post" class="contact-form">
        <div class="input-group">
          <input type="email" name="email" id="email" placeholder="Email" class="input-control contact">
        </div>
        <div class="input-group">
        ...
        <div class="input-group right-align">
          <button type="submit" name="send-message" class="btn big-btn green-btn">Enviar</button>
        </div>
      </form>
    </div>
  </div>
