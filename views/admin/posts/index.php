        ...
        <div class="table-container lg-box" style="margin-top: 0px;">
          ...
          <form class="featured-post-form" action="<?php url("/admin/posts/update-featured-post"); ?>" method="post">
            ...
            <span class="title-wrapper">
              ...
              <button type="button" class="change-featured-post">Cambiar</button>
            </span>
          ...
          <div class="table-actions">
            <div class="table-filter-group">
              ...
              <select name="filter-posts" id="filter-posts"
                ...
                <option value="OLDEST" <?php echo $postsFilter=='OLDEST' ? 'selected' : '' ?>>Creados primero</option>
                <option value="NEWEST" <?php echo $postsFilter=='NEWEST' ? 'selected' : '' ?>>;Últimos creados</option>
                <option value="POPULAR" <?php echo $postsFilter=='POPULAR' ? 'selected' : '' ?>>Más vistos</option>
                <option value="PUBLISHED" <?php echo $postsFilter=='PUBLISHED' ? 'selected' : '' ?>>Publicados</option>
                <option value="DRAFTS" <?php echo $postsFilter=='DRAFTS' ? 'selected' : '' ?>>Borradores</option>
              </select>
            </div>

            <div class="table-buttons">
              <a href="<?php url("/admin/posts/trash"); ?>" class="btn warning-btn small-btn">
                <ion-icon name="trash-outline" class="icon"></ion-icon> Eliminar
              </a>
              <a href="<?php url("/admin/posts/create"); ?>" class="btn primary-btn small-btn">
                <ion-icon name="add-circle-outline" class="icon"></ion-icon> Crear publicación
              </a>
            </div>
          </div>
          <div class="responsive-table">
            <table>
              ...
              <tbody>
                ...
                <?php else: ?>
                <tr>
                  <td colspan="6">No hay publicaciones!</td>
                </tr>
                <?php endif; ?>
