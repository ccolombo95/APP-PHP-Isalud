...
<?php
function displayPostAll($collection) {
  if (!isset($collection)) {
      return null;
  }
  ?>
  <section class="page-content index">
    <div class="main-content">
        ...
        <article class="post-card flat-card">
          ...
          <div class="post-info">
            ...
            <div class="author-info">
              ...
              <div>
                <a href="<?php url("/posts/" . $post['slug']); ?>">Leer más <ion-icon style="vertical-align: bottom;" name="arrow-forward-outline">
                  </ion-icon></a>
              </div>
            </div>
          </div>
      ...
      <?php endforeach;?>
      <button class="btn long-btn pink-btn"><a href="<?php url("/posts"); ?>">Ver más</a></button>
    </div>
  </section>
  <?php
}
    ...
    <section class="page-section">
      <div class="slider-container">
        <div class="slider-header">
          <h2 style="margin: 0px; padding: 0px;color:white;"><?php echo $collection['title']; ?></h2>
          <a href="<?php url("/collection/" . $collection['slug']); ?>">Ver más</a>
        </div>
...
<body>
  ...
  <div class="page-content homepage">
    ...
    <?php echo displayPostAll($firstCollection); ?>
    ...
    <?php if (!empty($this->topics)): ?>
      ...
      <div class="topics-pills">
        <?php foreach ($this->topics as $topic): ?>
          <button class="btn small-btn pink-btn"><a href="<?php url("/topics/" . $topic['slug']); ?>"><?php echo $topic['name']; ?></a></button>
        <?php endforeach;?>
      </div>
    </section>
    <?php endif;?>
